...
START_TEST (test_mul)
{
	...
	const FF_NUM p3 = {0xFFFFFC2F,0xFFFFFFFE,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF};
	...
	const FF_NUM r3 = {0x60BBA991,0xD28A4644,0x30CFD47F,0x571A0E25,0x2994A715,0x12902A82,0xC4744637,0x6F695E19};
	...
	ff_mul (&d, &a, &b, &p3);
	mu_assert (ff_compare (&d, &r3) == 0, "ff_mul should multiply arguments (mod secp256k1 prime).");
